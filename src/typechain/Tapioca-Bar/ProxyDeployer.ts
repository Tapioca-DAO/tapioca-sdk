...
export interface ProxyDeployerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "deployWithCreate2(address,bytes32)",
    values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "proxies(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  getEvent(nameOrSignatureOrTopic: "LogDeploy(address,address)"): EventFragment;
}
