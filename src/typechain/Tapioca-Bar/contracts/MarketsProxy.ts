...
export interface MarketsProxyInterface extends utils.Interface {
  functions: {
    ...
    "executeOnChain(uint16,bytes,bytes[],bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "executeOnChain(uint16,bytes,bytes[],bytes)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BytesLike>[],
  ...
  encodeFunctionData(
    functionFragment: "updateMarketStatus(address,bool)",
    values: [PromiseOrValue<string>, PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "LogMarketStatus(address,bool)"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "ReceiveFromChain(uint16,address,bytes)"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "SendToChain(uint16,address,bytes)"
  ): EventFragment;
...
export interface MarketsProxy extends BaseContract {
  ...
  functions: {
    ...
    executeOnChain(
      ...
      _marketDstAddress: PromiseOrValue<BytesLike>,
