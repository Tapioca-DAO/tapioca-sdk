...
export interface BeachBarInterface extends utils.Interface {
  functions: {
    ...
    "withdrawAllProtocolFees(address[],(uint256)[])": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "withdrawAllProtocolFees(address[],(uint256)[])"
      | "yieldBox"
      | "yieldBox()"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "executeMixologistFn(address[],bytes[])",
    values: [PromiseOrValue<string>[], PromiseOrValue<BytesLike>[]]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "masterContracts(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "registerMasterContract(address,uint8)",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "registerMixologist(address,bytes,bool)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<boolean>
  ...
  encodeFunctionData(
    functionFragment: "setFeeVeTap(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setSwapper(address,bool)",
    values: [PromiseOrValue<string>, PromiseOrValue<boolean>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "withdrawAllProtocolFees(address[],(uint256)[])",
    values: [PromiseOrValue<string>[], SwapDataStruct[]]
  ): string;
  ...
  getEvent(nameOrSignatureOrTopic: "FeeVeTapUpdate(address)"): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "RegisterMasterContract(address,uint8)"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RegisterMixologist"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "RegisterMixologist(address,address)"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "SwapperUpdate"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "SwapperUpdate(address,bool)"
  ): EventFragment;
