...
export type SwapDataStructOutput = [BigNumber] & { minAssetAmount: BigNumber };
...
export interface MixologistInterface extends utils.Interface {
  functions: {
    ...
    "setLiquidationQueue(address,(uint256,uint256,address,address,address))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "depositFeesToYieldBox(address,(uint256))"
      | "exchangeRate"
      | "exchangeRate()"
      | "execute"
      | "execute(bytes[],bool)"
      ...
      | "setLiquidationQueue"
      | "setLiquidationQueue(address,(uint256,uint256,address,address,address))"
      | "setTapSwapPath"
  ...
  encodeFunctionData(
    functionFragment: "computeAssetAmountToSolvency(address,uint256)",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<string>, SwapDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "depositFeesToYieldBox(address,(uint256))",
    values: [PromiseOrValue<string>, SwapDataStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setCollateralSwapPath(address[])",
    values: [PromiseOrValue<string>[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setLiquidationQueue(address,(uint256,uint256,address,address,address))",
    values: [PromiseOrValue<string>, LiquidationQueueMetaStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTapSwapPath(address[])",
    values: [PromiseOrValue<string>[]]
  ): string;
  ...
  getEvent(
    nameOrSignatureOrTopic: "LogApprovalForAll(address,address,bool)"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "LogFlashLoan(address,uint256,uint256,address)"
  ): EventFragment;
...
export interface Mixologist extends BaseContract {
  ...
  functions: {
    ...
    computeAssetAmountToSolvency(
      ...
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { amountToSolvency: BigNumber }>;
