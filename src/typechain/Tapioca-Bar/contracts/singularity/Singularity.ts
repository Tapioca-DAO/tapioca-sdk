...
export interface SingularityInterface extends utils.Interface {
  functions: {
    ...
    "withdrawTo(address,uint16,bytes,uint256,bytes,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "setClosedCollateralizationRate(uint256)"
      | "setConservator"
      ...
      | "withdrawFeesEarned()"
      | "withdrawTo"
      | "withdrawTo(address,uint16,bytes,uint256,bytes,address)"
      | "yieldBox"
      | "yieldBox()"
      | "yieldBoxShares"
  ...
  encodeFunctionData(
    functionFragment: "setClosedCollateralizationRate(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "withdrawTo(address,uint16,bytes,uint256,bytes,address)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
