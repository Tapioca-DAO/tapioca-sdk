...
export interface BigBangInterface extends utils.Interface {
  functions: {
    ...
    "withdrawTo(uint16,bytes,uint256,bytes,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "withdrawTo"
      | "withdrawTo(uint16,bytes,uint256,bytes,address)"
      | "yieldBox"
      | "yieldBox()"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "updateBorrowingFee(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "withdrawTo(uint16,bytes,uint256,bytes,address)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BigNumberish>,
  ...
  getEvent(
    nameOrSignatureOrTopic: "LogStabilityFee(uint256,uint256)"
  ): EventFragment;
