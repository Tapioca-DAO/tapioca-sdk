...
export interface ERC20MockWithPermitInterface extends utils.Interface {
  functions: {
...
export interface ERC20MockWithPermit extends BaseContract {
  contractName: "ERC20MockWithPermit";
