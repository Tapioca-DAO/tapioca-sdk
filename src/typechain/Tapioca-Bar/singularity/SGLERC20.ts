...
export interface SGLERC20Interface extends utils.Interface {
  functions: {
...
export interface SGLERC20 extends BaseContract {
  contractName: "SGLERC20";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SGLERC20Interface;
