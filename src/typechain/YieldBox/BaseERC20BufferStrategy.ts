...
export interface BaseERC20BufferStrategyInterface extends utils.Interface {
  contractName: "BaseERC20BufferStrategy";
  functions: {
...
export interface BaseERC20BufferStrategy extends BaseContract {
  contractName: "BaseERC20BufferStrategy";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseERC20BufferStrategyInterface;
