...
export interface ERC721StrategyMockInterface extends utils.Interface {
  contractName: "ERC721StrategyMock";
  functions: {
...
export interface ERC721StrategyMock extends BaseContract {
  contractName: "ERC721StrategyMock";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721StrategyMockInterface;
