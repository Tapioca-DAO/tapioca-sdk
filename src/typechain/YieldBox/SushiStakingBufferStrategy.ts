...
export interface SushiStakingBufferStrategyInterface extends utils.Interface {
  contractName: "SushiStakingBufferStrategy";
  functions: {
...
export interface SushiStakingBufferStrategy extends BaseContract {
  contractName: "SushiStakingBufferStrategy";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SushiStakingBufferStrategyInterface;
