...
export interface SushiStakingStrategyInterface extends utils.Interface {
  functions: {
...
export interface SushiStakingStrategy extends BaseContract {
  contractName: "SushiStakingStrategy";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SushiStakingStrategyInterface;
