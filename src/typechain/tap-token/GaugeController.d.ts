...
export class GaugeController extends BaseContract {
  ...
  functions: {
    ...
    total_gauges(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    total_gauges(overrides?: CallOverrides): Promise<PopulatedTransaction>;
