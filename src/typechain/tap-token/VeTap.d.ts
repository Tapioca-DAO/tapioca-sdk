...
interface VeTapInterface extends ethers.utils.Interface {
  functions: {
    "commit_transfer_ownership(address)": FunctionFragment;
    "apply_transfer_ownership()": FunctionFragment;
    "whitelist_contract(address)": FunctionFragment;
    "remove_whitelisted_contract(address)": FunctionFragment;
    ...
    "queuedPenalty()": FunctionFragment;
    "lastPenaltyTranfer()": FunctionFragment;
    ...
    "whitelisted_contracts(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "whitelist_contract",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "remove_whitelisted_contract",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "queuedPenalty",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "lastPenaltyTranfer",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "whitelisted_contracts",
    values: [string]
  ): string;
...
export class VeTap extends BaseContract {
  ...
  functions: {
    ...
    remove_whitelisted_contract(
      addr: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "remove_whitelisted_contract(address)"(
      addr: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    queuedPenalty(overrides?: CallOverrides): Promise<[BigNumber]>;

    "queuedPenalty()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    lastPenaltyTranfer(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    whitelist_contract(addr: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    queuedPenalty(overrides?: CallOverrides): Promise<PopulatedTransaction>;
