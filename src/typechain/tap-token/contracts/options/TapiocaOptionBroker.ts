...
export interface TapiocaOptionBrokerInterface extends utils.Interface {
  ...
  events: {
    ...
    "Participate(uint256,uint256,uint256,uint256,uint256)": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "Participate(uint256,uint256,uint256,uint256,uint256)"
  ): EventFragment;
...
export interface TapiocaOptionBroker extends BaseContract {
  ...
  filters: {
    ...
    "Participate(uint256,uint256,uint256,uint256,uint256)"(
      epoch?: PromiseOrValue<BigNumberish> | null,
