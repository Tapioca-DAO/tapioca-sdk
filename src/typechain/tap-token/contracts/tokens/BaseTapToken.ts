...
export interface BaseTapTokenInterface extends utils.Interface {
  functions: {
...
export interface BaseTapToken extends BaseContract {
  contractName: "BaseTapToken";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseTapTokenInterface;
