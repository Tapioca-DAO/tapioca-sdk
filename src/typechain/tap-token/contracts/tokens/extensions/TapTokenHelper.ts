...
export type ClaimTwTapRewardsMsgStruct = {
  tokenId: PromiseOrValue<BigNumberish>;
  sendParam: LZSendParamStruct[];
};

export type ClaimTwTapRewardsMsgStructOutput = [
  BigNumber,
  LZSendParamStructOutput[]
] & { tokenId: BigNumber; sendParam: LZSendParamStructOutput[] };

export type LockTwTapPositionMsgStruct = {
  user: PromiseOrValue<string>;
  duration: PromiseOrValue<BigNumberish>;
  amount: PromiseOrValue<BigNumberish>;
};

export type LockTwTapPositionMsgStructOutput = [
  string,
  BigNumber,
  BigNumber
] & { user: string; duration: BigNumber; amount: BigNumber };
...
export type UnlockTwTapPositionMsgStruct = {
  user: PromiseOrValue<string>;
  tokenId: PromiseOrValue<BigNumberish>;
};

export type UnlockTwTapPositionMsgStructOutput = [string, BigNumber] & {
  user: string;
  tokenId: BigNumber;
};
...
export interface TapTokenHelperInterface extends utils.Interface {
  functions: {
    "MSG_SEND()": FunctionFragment;
    "buildClaimRewardsMsg((uint256,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address)[]))": FunctionFragment;
    "buildLockTwTapPositionMsg((address,uint96,uint256))": FunctionFragment;
    ...
    "buildUnlockTwpTapPositionMsg((address,uint256))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "buildClaimRewardsMsg((uint256,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address)[]))"
      | "buildLockTwTapPositionMsg"
      | "buildLockTwTapPositionMsg((address,uint96,uint256))"
      ...
      | "buildUnlockTwpTapPositionMsg"
      | "buildUnlockTwpTapPositionMsg((address,uint256))"
  ...
  encodeFunctionData(
    functionFragment: "buildClaimRewardsMsg",
    values: [ClaimTwTapRewardsMsgStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "buildClaimRewardsMsg((uint256,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address)[]))",
    values: [ClaimTwTapRewardsMsgStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "buildLockTwTapPositionMsg",
    values: [LockTwTapPositionMsgStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "buildLockTwTapPositionMsg((address,uint96,uint256))",
    values: [LockTwTapPositionMsgStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "buildUnlockTwpTapPositionMsg",
    values: [UnlockTwTapPositionMsgStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "buildUnlockTwpTapPositionMsg((address,uint256))",
    values: [UnlockTwTapPositionMsgStruct]
  ): string;
  encodeFunctionData(
...
export interface TapTokenHelper extends BaseContract {
  contractName: "TapTokenHelper";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TapTokenHelperInterface;
  ...
  functions: {
    ...
    buildClaimRewardsMsg(
      _claimTwTapRewardsMsg: ClaimTwTapRewardsMsgStruct,
    ...
    buildLockTwTapPositionMsg(
      _lockTwTapPositionMsg: LockTwTapPositionMsgStruct,
      overrides?: CallOverrides
    ): Promise<[string]>;
    ...
    buildUnlockTwpTapPositionMsg(
      _unlockTwTapPositionMsg: UnlockTwTapPositionMsgStruct,
      overrides?: CallOverrides
    ): Promise<[string]>;
