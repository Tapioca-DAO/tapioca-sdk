...
export interface ERC20WithoutStrategyMockInterface extends utils.Interface {
  functions: {
...
export interface ERC20WithoutStrategyMock extends BaseContract {
  contractName: "ERC20WithoutStrategyMock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20WithoutStrategyMockInterface;
