...
export interface TapiocaOptionBrokerMockInterface extends utils.Interface {
  functions: {
...
export interface TapiocaOptionBrokerMock extends BaseContract {
  contractName: "TapiocaOptionBrokerMock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TapiocaOptionBrokerMockInterface;
