...
export interface TwTAPInterface extends utils.Interface {
  functions: {
    ...
    "setNftLoader(address)": FunctionFragment;
    "setPause(bool)": FunctionFragment;
    "setPearlmit(address)": FunctionFragment;
    "setVirtualTotalAmount(uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getRewardTokens()"
      | "getTypedDataHash"
      | "getTypedDataHash((address,uint256,uint256,uint256))"
      | "isApprovedForAll"
      ...
      | "setNftLoader"
      | "setNftLoader(address)"
      | "setPause"
      | "setPause(bool)"
      | "setPearlmit"
      | "setPearlmit(address)"
      | "setVirtualTotalAmount"
      | "setVirtualTotalAmount(uint256)"
      | "supportsInterface"
  ...
  encodeFunctionData(
    functionFragment: "exitPosition(uint256,address)",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getTypedDataHash((address,uint256,uint256,uint256))",
    values: [ERC721PermitStructStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setNftLoader(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setVirtualTotalAmount(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface TwTAP extends BaseContract {
  ...
  functions: {
    ...
    nftLoader(overrides?: CallOverrides): Promise<[string]>;
    ...
    setNftLoader(
      _nftLoader: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setVirtualTotalAmount(
      _virtualTotalAmount: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    nftLoader(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    nftLoader(overrides?: CallOverrides): Promise<PopulatedTransaction>;
