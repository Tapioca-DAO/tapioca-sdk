...
export interface TapTokenSenderInterface extends utils.Interface {
  functions: {
...
export interface TapTokenSender extends BaseContract {
  contractName: "TapTokenSender";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TapTokenSenderInterface;
