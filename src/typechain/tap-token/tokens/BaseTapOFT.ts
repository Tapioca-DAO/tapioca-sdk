...
export interface BaseTapOFTInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "lockTwTapPosition"
      | "lockTwTapPosition(address,uint256,uint256,uint16,address,bytes)"
      | "lzEndpoint"
      | "lzEndpoint()"
      | "lzReceive"
  ...
  encodeFunctionData(
    functionFragment: "lockTwTapPosition",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "lockTwTapPosition(address,uint256,uint256,uint16,address,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(functionFragment: "twTap()", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "unlockTwTapPosition",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "unlockTwTapPosition(address,uint256,uint16,address,bytes,(address,address,bytes))",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  getEvent(nameOrSignatureOrTopic: "CallFailedStr"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "CallFailedStr(uint16,bytes,string)"
  ): EventFragment;
...
export interface CallFailedStrEventObject {
  _srcChainId: number;
  _payload: string;
  _reason: string;
}
export type CallFailedStrEvent = TypedEvent<
  [number, string, string],
  CallFailedStrEventObject
>;

export type CallFailedStrEventFilter = TypedEventFilter<CallFailedStrEvent>;
