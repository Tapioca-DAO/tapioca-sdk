...
export interface YieldBoxVaultStratInterface extends utils.Interface {
  functions: {
...
export interface YieldBoxVaultStrat extends BaseContract {
  contractName: "YieldBoxVaultStrat";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: YieldBoxVaultStratInterface;
