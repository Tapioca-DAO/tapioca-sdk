...
export class USDOCommon__factory {
  static readonly abi = _abi;
  static createInterface(): USDOCommonInterface {
    return new utils.Interface(_abi) as USDOCommonInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): USDOCommon {
    return new Contract(address, _abi, signerOrProvider) as USDOCommon;
  }
}
