...
export interface AssetToEthLeverageExecutorInterface extends utils.Interface {
  functions: {
...
export interface AssetToEthLeverageExecutor extends BaseContract {
  contractName: "AssetToEthLeverageExecutor";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AssetToEthLeverageExecutorInterface;
