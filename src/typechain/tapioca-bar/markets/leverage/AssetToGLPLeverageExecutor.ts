...
export interface AssetToGLPLeverageExecutorInterface extends utils.Interface {
  functions: {
...
export interface AssetToGLPLeverageExecutor extends BaseContract {
  contractName: "AssetToGLPLeverageExecutor";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AssetToGLPLeverageExecutorInterface;
