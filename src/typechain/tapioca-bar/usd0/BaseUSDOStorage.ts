...
export interface BaseUSDOStorageInterface extends utils.Interface {
  functions: {
...
export interface BaseUSDOStorage extends BaseContract {
  contractName: "BaseUSDOStorage";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseUSDOStorageInterface;
