...
export interface USDOMocksInterface extends utils.Interface {
  functions: {
...
export interface USDOMocks extends BaseContract {
  contractName: "USDOMocks";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: USDOMocksInterface;
