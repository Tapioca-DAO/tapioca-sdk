...
export interface USDOCommonInterface extends utils.Interface {
  functions: {
...
export interface USDOCommon extends BaseContract {
  contractName: "USDOCommon";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: USDOCommonInterface;
