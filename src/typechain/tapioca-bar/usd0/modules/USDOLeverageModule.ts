...
export interface USDOLeverageModuleInterface extends utils.Interface {
  functions: {
    ...
    "leverageUp(address,uint16,bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "leverageUp"
      | "leverageUp(address,uint16,bytes)"
      | "leverageUpInternal"
  ...
  encodeFunctionData(
    functionFragment: "leverageUp(address,uint16,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>
  ...
  encodeFunctionData(
    functionFragment: "leverageUpInternal",
    values: [
      PromiseOrValue<BigNumberish>,
      IUSDOBase.ILeverageSwapDataStruct,
      IUSDOBase.ILeverageExternalContractsDataStruct,
...
export interface USDOLeverageModule extends BaseContract {
  contractName: "USDOLeverageModule";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: USDOLeverageModuleInterface;
