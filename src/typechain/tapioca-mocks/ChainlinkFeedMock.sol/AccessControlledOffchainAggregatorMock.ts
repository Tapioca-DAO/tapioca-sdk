...
export interface AccessControlledOffchainAggregatorMockInterface
...
export interface AccessControlledOffchainAggregatorMock extends BaseContract {
  contractName: "AccessControlledOffchainAggregatorMock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccessControlledOffchainAggregatorMockInterface;
