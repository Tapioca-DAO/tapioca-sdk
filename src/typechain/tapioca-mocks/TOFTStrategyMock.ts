...
export interface TOFTStrategyMockInterface extends utils.Interface {
  functions: {
...
export interface TOFTStrategyMock extends BaseContract {
  contractName: "TOFTStrategyMock";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TOFTStrategyMockInterface;
  ...
  functions: {
    ...
    vaultAmount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    vaultAmount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
