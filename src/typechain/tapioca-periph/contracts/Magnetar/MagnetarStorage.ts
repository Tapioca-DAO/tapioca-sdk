...
export interface MagnetarStorageInterface extends utils.Interface {
  functions: {
...
export interface MagnetarStorage extends BaseContract {
  contractName: "MagnetarStorage";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagnetarStorageInterface;
