...
export interface MagnetarAssetCommonModuleInterface extends utils.Interface {
  functions: {
...
export interface MagnetarAssetCommonModule extends BaseContract {
  contractName: "MagnetarAssetCommonModule";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagnetarAssetCommonModuleInterface;
