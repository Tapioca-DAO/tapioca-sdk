...
export type DepositRepayAndRemoveCollateralFromMarketDataStruct = {
  ...
  withdrawCollateralParams: MagnetarWithdrawDataStruct;
};
...
export type DepositRepayAndRemoveCollateralFromMarketDataStructOutput = [
  ...
  withdrawCollateralParams: MagnetarWithdrawDataStructOutput;
};

export interface MagnetarAssetModuleInterface extends utils.Interface {
  functions: {
    ...
    "depositRepayAndRemoveCollateralFromMarket((address,address,address,uint256,uint256,uint256,(address,uint256,bool,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address),uint128,uint128,uint128,uint128,bytes,uint16,bool)))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "depositRepayAndRemoveCollateralFromMarket((address,address,address,uint256,uint256,uint256,(address,uint256,bool,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address),uint128,uint128,uint128,uint128,bytes,uint16,bool)))"
      | "onERC721Received"
  ...
  encodeFunctionData(
    ...
    values: [DepositRepayAndRemoveCollateralFromMarketDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "depositRepayAndRemoveCollateralFromMarket((address,address,address,uint256,uint256,uint256,(address,uint256,bool,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address),uint128,uint128,uint128,uint128,bytes,uint16,bool)))",
    values: [DepositRepayAndRemoveCollateralFromMarketDataStruct]
  ): string;
  encodeFunctionData(
...
export interface MagnetarAssetModule extends BaseContract {
  contractName: "MagnetarAssetModule";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagnetarAssetModuleInterface;
  ...
  functions: {
    ...
    depositRepayAndRemoveCollateralFromMarket(
      data: DepositRepayAndRemoveCollateralFromMarketDataStruct,
