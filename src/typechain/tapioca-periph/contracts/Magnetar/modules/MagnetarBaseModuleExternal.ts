...
export type MagnetarWithdrawDataStruct = {
  ...
  sendGas: PromiseOrValue<BigNumberish>;
  composeGas: PromiseOrValue<BigNumberish>;
  sendVal: PromiseOrValue<BigNumberish>;
  composeVal: PromiseOrValue<BigNumberish>;
  composeMsg: PromiseOrValue<BytesLike>;
  composeMsgType: PromiseOrValue<BigNumberish>;
...
export type MagnetarWithdrawDataStructOutput = [
  ...
  sendVal: BigNumber;
  composeVal: BigNumber;
  composeMsg: string;
  composeMsgType: number;
  withdraw: boolean;
};

export interface MagnetarBaseModuleExternalInterface extends utils.Interface {
  functions: {
    ...
    "extractTokens(address,address,uint256)": FunctionFragment;
    "onERC721Received(address,address,uint256,bytes)": FunctionFragment;
    "owner()": FunctionFragment;
    "pearlmit()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "revertYieldBoxApproval(address,address)": FunctionFragment;
    "setApprovalForYieldBox(address,address)": FunctionFragment;
    "setPearlmit(address)": FunctionFragment;
    "transferOwnership(address)": FunctionFragment;
    "withdrawToChain((address,uint256,bool,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address),uint128,uint128,uint128,uint128,bytes,uint16,bool))": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "MAGNETAR_ACTION_YIELDBOX_MODULE()"
      | "extractTokens"
      | "extractTokens(address,address,uint256)"
      | "onERC721Received"
      ...
      | "renounceOwnership"
      | "renounceOwnership()"
      | "revertYieldBoxApproval"
      | "revertYieldBoxApproval(address,address)"
      | "setApprovalForYieldBox"
      | "setApprovalForYieldBox(address,address)"
      | "setPearlmit"
      | "setPearlmit(address)"
      | "transferOwnership"
      | "transferOwnership(address)"
      | "withdrawToChain"
      | "withdrawToChain((address,uint256,bool,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address),uint128,uint128,uint128,uint128,bytes,uint16,bool))"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "extractTokens(address,address,uint256)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>
  ...
  encodeFunctionData(
    functionFragment: "revertYieldBoxApproval",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "revertYieldBoxApproval(address,address)",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "setApprovalForYieldBox",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "setApprovalForYieldBox(address,address)",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "withdrawToChain((address,uint256,bool,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address),uint128,uint128,uint128,uint128,bytes,uint16,bool))",
    values: [MagnetarWithdrawDataStruct]
  ): string;
...
export interface MagnetarBaseModuleExternal extends BaseContract {
  contractName: "MagnetarBaseModuleExternal";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagnetarBaseModuleExternalInterface;
