...
export interface MagnetarCollateralModuleInterface extends utils.Interface {
  functions: {
    ...
    "depositAddCollateralAndBorrowFromMarket((address,address,address,uint256,uint256,bool,(address,uint256,bool,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address),uint128,uint128,uint128,uint128,bytes,uint16,bool)))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "depositAddCollateralAndBorrowFromMarket((address,address,address,uint256,uint256,bool,(address,uint256,bool,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address),uint128,uint128,uint128,uint128,bytes,uint16,bool)))"
      | "onERC721Received"
  ...
  encodeFunctionData(
    ...
    values: [DepositAddCollateralAndBorrowFromMarketDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "depositAddCollateralAndBorrowFromMarket((address,address,address,uint256,uint256,bool,(address,uint256,bool,((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),(uint256,uint256),bytes,address),uint128,uint128,uint128,uint128,bytes,uint16,bool)))",
    values: [DepositAddCollateralAndBorrowFromMarketDataStruct]
  ): string;
  encodeFunctionData(
...
export interface MagnetarCollateralModule extends BaseContract {
  contractName: "MagnetarCollateralModule";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagnetarCollateralModuleInterface;
  ...
  functions: {
    ...
    depositAddCollateralAndBorrowFromMarket(
      data: DepositAddCollateralAndBorrowFromMarketDataStruct,
