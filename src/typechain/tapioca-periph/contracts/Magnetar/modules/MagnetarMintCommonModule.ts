...
export interface MagnetarMintCommonModuleInterface extends utils.Interface {
  functions: {
...
export interface MagnetarMintCommonModule extends BaseContract {
  contractName: "MagnetarMintCommonModule";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagnetarMintCommonModuleInterface;
