...
export interface TapiocaMulticallInterface extends utils.Interface {
  functions: {
...
export interface TapiocaMulticall extends BaseContract {
  contractName: "TapiocaMulticall";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TapiocaMulticallInterface;
