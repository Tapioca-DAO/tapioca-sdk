...
export interface ProxyOFTWithFeeInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "sendAndCall"
      | "sendAndCall(address,uint16,bytes32,uint256,uint256,bytes,uint64,(address,address,bytes))"
      | "sendFrom"
  ...
  encodeFunctionData(
    functionFragment: "sendAndCall(address,uint16,bytes32,uint256,uint256,bytes,uint64,(address,address,bytes))",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
  ...
  encodeFunctionData(
    functionFragment: "sendFrom(address,uint16,bytes32,uint256,uint256,(address,address,bytes))",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
