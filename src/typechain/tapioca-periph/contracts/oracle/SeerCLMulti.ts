...
export type OracleChainlinkMultiConstructorDataStruct = {
...
export type OracleChainlinkMultiConstructorDataStructOutput = [
  string[],
  number[],
  BigNumber,
  string[],
...
export interface SeerCLMultiInterface extends utils.Interface {
  functions: {
...
export interface SeerCLMulti extends BaseContract {
  contractName: "SeerCLMulti";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SeerCLMultiInterface;
