...
export interface DualETHOracleInterface extends utils.Interface {
  functions: {
    ...
    "seerClEthOracle()": FunctionFragment;
    "seerUniEthOracle()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "seerClEthOracle",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "seerClEthOracle()",
  ...
  encodeFunctionData(
    functionFragment: "seerUniEthOracle",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "seerUniEthOracle()",
...
export interface DualETHOracle extends BaseContract {
  contractName: "DualETHOracle";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DualETHOracleInterface;
  ...
  functions: {
    ...
    seerClEthOracle(overrides?: CallOverrides): Promise<[string]>;

    "seerClEthOracle()"(overrides?: CallOverrides): Promise<[string]>;

    seerUniEthOracle(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    seerClEthOracle(overrides?: CallOverrides): Promise<BigNumber>;

    "seerClEthOracle()"(overrides?: CallOverrides): Promise<BigNumber>;

    seerUniEthOracle(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    seerClEthOracle(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "seerClEthOracle()"(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;

    seerUniEthOracle(overrides?: CallOverrides): Promise<PopulatedTransaction>;
