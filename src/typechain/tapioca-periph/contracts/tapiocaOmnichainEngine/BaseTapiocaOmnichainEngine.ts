...
export interface BaseTapiocaOmnichainEngineInterface extends utils.Interface {
  functions: {
...
export interface BaseTapiocaOmnichainEngine extends BaseContract {
  contractName: "BaseTapiocaOmnichainEngine";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseTapiocaOmnichainEngineInterface;
