...
export interface MagnetarAssetModuleInterface extends utils.Interface {
  functions: {
    ...
    "depositRepayAndRemoveCollateralFromMarket((address,address,address,uint256,uint256,uint256,(address,uint256,address,uint256,bool,bool)))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "depositRepayAndRemoveCollateralFromMarket((address,address,address,uint256,uint256,uint256,(address,uint256,address,uint256,bool,bool)))"
      | "helper"
      | "helper()"
      | "onERC721Received"
  ...
  encodeFunctionData(
    functionFragment: "depositRepayAndRemoveCollateralFromMarket((address,address,address,uint256,uint256,uint256,(address,uint256,address,uint256,bool,bool)))",
    values: [DepositRepayAndRemoveCollateralFromMarketDataStruct]
  ): string;
