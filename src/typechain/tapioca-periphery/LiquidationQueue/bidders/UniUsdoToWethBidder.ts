...
export interface UniUsdoToWethBidderInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "getInputAmount(address,uint256,uint256,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "getOutputAmount(address,uint256,uint256,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "setUniswapSwapper(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "swap(address,uint256,uint256,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  getEvent(
    nameOrSignatureOrTopic: "UniV2SwapperUpdated(address,address)"
  ): EventFragment;
}
...
export interface UniUsdoToWethBidder extends BaseContract {
  contractName: "UniUsdoToWethBidder";
