...
export interface NonYieldBoxMultiSwapperInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "getInputAmount"
      | "getInputAmount(address[],uint256)"
      | "getOutputAmount"
      | "getOutputAmount(address[],uint256)"
      | "swap"
  ...
  encodeFunctionData(
    functionFragment: "getInputAmount(address[],uint256)",
    values: [PromiseOrValue<string>[], PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getOutputAmount(address[],uint256)",
    values: [PromiseOrValue<string>[], PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "swap(address,address,uint256,address,address[],uint256)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
...
export interface NonYieldBoxMultiSwapper extends BaseContract {
  contractName: "NonYieldBoxMultiSwapper";
