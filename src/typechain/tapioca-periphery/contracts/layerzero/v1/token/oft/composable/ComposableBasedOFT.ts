...
export interface ComposableBasedOFTInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "failedOFTReceivedMessages(uint16,bytes,uint64)"
      | "forceResumeReceive"
      ...
      | "sendAndCall"
      | "sendAndCall(address,uint16,bytes,uint256,bytes,uint64,address,address,bytes)"
      | "sendFrom"
  ...
  encodeFunctionData(
    functionFragment: "estimateSendAndCallFee(uint16,bytes,uint256,bytes,uint64,bool,bytes)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "failedOFTReceivedMessages(uint16,bytes,uint64)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BigNumberish>
  ...
  encodeFunctionData(
    functionFragment: "retryOFTReceived(uint16,bytes,uint64,bytes,address,uint256,bytes)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "sendAndCall(address,uint16,bytes,uint256,bytes,uint64,address,address,bytes)",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
  ...
  getEvent(
    nameOrSignatureOrTopic: "CallOFTReceivedFailure(uint16,bytes,uint64,bytes,address,uint256,bytes,bytes)"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "RetryOFTReceivedSuccess(bytes32)"
  ): EventFragment;
...
export interface ComposableBasedOFT extends BaseContract {
  contractName: "ComposableBasedOFT";
