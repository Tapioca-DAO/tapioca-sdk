...
export interface OracleChainlinkMultiEfficientInterface
...
export interface OracleChainlinkMultiEfficient extends BaseContract {
  ...
  interface: OracleChainlinkMultiEfficientInterface;
