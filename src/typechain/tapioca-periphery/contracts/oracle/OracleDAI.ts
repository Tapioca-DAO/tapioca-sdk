...
export interface OracleDAIInterface extends utils.Interface {
  functions: {
...
export interface OracleDAI extends BaseContract {
  contractName: "OracleDAI";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OracleDAIInterface;
