...
export interface TapOracleInterface extends utils.Interface {
  functions: {
    ...
    "updateFetchTime(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "updateFetchTime(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface TapOracle extends BaseContract {
  contractName: "TapOracle";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TapOracleInterface;
