...
export interface TapiocaOmnichainReceiverInterface extends utils.Interface {
  functions: {
...
export interface TapiocaOmnichainReceiver extends BaseContract {
  contractName: "TapiocaOmnichainReceiver";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TapiocaOmnichainReceiverInterface;
