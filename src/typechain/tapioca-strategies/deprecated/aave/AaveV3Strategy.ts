...
export interface AaveV3StrategyInterface extends utils.Interface {
  functions: {
    ...
    "stakedRewardToken()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "stakedRewardToken",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "stakedRewardToken()",
...
export interface AaveV3Strategy extends BaseContract {
  ...
  functions: {
    ...
    stakedRewardToken(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    stakedRewardToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    stakedRewardToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
