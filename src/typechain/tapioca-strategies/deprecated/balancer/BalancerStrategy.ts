...
export interface BalancerStrategyInterface extends utils.Interface {
  functions: {
    ...
    "setSlippageIn(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setSlippageIn",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "setSlippageIn(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
