...
export interface CTokenMockInterface extends utils.Interface {
  functions: {
    ...
    "comptrollerAddr()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "comptrollerAddr",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "comptrollerAddr()",
...
export interface CTokenMock extends BaseContract {
  ...
  functions: {
    ...
    comptrollerAddr(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    comptrollerAddr(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    comptrollerAddr(overrides?: CallOverrides): Promise<PopulatedTransaction>;
