...
export interface ConvexTricryptoStrategyInterface extends utils.Interface {
  functions: {
    ...
    "defaultSwapDatas(address)": FunctionFragment;
    ...
    "setDefaultSwapData(address,bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "rewardToken()"
      | "setDefaultSwapData"
      | "setDefaultSwapData(address,bytes)"
      | "setDepositThreshold"
  ...
  encodeFunctionData(
    functionFragment: "defaultSwapDatas",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "defaultSwapDatas(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setDefaultSwapData(address,bytes)",
    values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export interface ConvexTricryptoStrategy extends BaseContract {
  contractName: "ConvexTricryptoStrategy";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConvexTricryptoStrategyInterface;
