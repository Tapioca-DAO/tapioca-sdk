...
export interface SDaiStrategyInterface extends utils.Interface {
  functions: {
...
export interface SDaiStrategy extends BaseContract {
  contractName: "SDaiStrategy";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SDaiStrategyInterface;
