...
import type {
  MarketStateView,
  MarketStateViewInterface,
} from "../../markets/MarketStateView";
...
export class MarketStateView__factory {
  static readonly abi = _abi;
  static createInterface(): MarketStateViewInterface {
    return new utils.Interface(_abi) as MarketStateViewInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MarketStateView {
    return new Contract(address, _abi, signerOrProvider) as MarketStateView;
  }
}
