...
export class TOFTCommon__factory {
  static readonly abi = _abi;
  static createInterface(): TOFTCommonInterface {
    return new utils.Interface(_abi) as TOFTCommonInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TOFTCommon {
    return new Contract(address, _abi, signerOrProvider) as TOFTCommon;
  }
}
