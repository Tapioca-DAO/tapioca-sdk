...
export interface MarketStateViewInterface extends utils.Interface {
  functions: {
...
export interface MarketStateView extends BaseContract {
  contractName: "MarketStateView";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MarketStateViewInterface;
