...
export declare namespace SGLCommon {
  export type _ViewLiquidationStructStruct = {
    ...
    liquidationBonusAmount: PromiseOrValue<BigNumberish>;
    liquidationCollateralizationRate: PromiseOrValue<BigNumberish>;
    liquidationMultiplier: PromiseOrValue<BigNumberish>;
    exchangeRatePrecision: PromiseOrValue<BigNumberish>;
    feeDecimalsPrecision: PromiseOrValue<BigNumberish>;
  };

  export type _ViewLiquidationStructStructOutput = [
    string,
    BigNumber,
    BigNumber,
    BigNumber,
    ...
    user: string;
    maxBorrowPart: BigNumber;
    minLiquidationBonus: BigNumber;
    ...
    liquidationBonusAmount: BigNumber;
    liquidationCollateralizationRate: BigNumber;
    liquidationMultiplier: BigNumber;
    exchangeRatePrecision: BigNumber;
    feeDecimalsPrecision: BigNumber;
  };
}
...
export interface SGLLiquidationInterface extends utils.Interface {
  functions: {
    ...
    "viewLiquidationCollateralAmount((address,uint256,uint256,uint256,address,uint256,uint256,uint256,(uint128,uint128),uint256,uint256,uint256,uint256,uint256))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "viewLiquidationCollateralAmount((address,uint256,uint256,uint256,address,uint256,uint256,uint256,(uint128,uint128),uint256,uint256,uint256,uint256,uint256))"
      | "yieldBox"
      | "yieldBox()"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [SGLCommon._ViewLiquidationStructStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "viewLiquidationCollateralAmount((address,uint256,uint256,uint256,address,uint256,uint256,uint256,(uint128,uint128),uint256,uint256,uint256,uint256,uint256))",
    values: [SGLCommon._ViewLiquidationStructStruct]
  ): string;
...
export interface SGLLiquidation extends BaseContract {
  ...
  functions: {
    ...
    viewLiquidationCollateralAmount(
      _data: SGLCommon._ViewLiquidationStructStruct,
      overrides?: CallOverrides
