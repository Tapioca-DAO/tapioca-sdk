...
export interface BaseTOFTStorageInterface extends utils.Interface {
  functions: {
...
export interface BaseTOFTStorage extends BaseContract {
  contractName: "BaseTOFTStorage";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseTOFTStorageInterface;
