...
export interface BaseTOFTModuleInterface extends utils.Interface {
  functions: {
...
export interface BaseTOFTModule extends BaseContract {
  contractName: "BaseTOFTModule";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseTOFTModuleInterface;
