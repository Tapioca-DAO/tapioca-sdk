...
export interface UsdoLeverageReceiverModuleInterface extends utils.Interface {
  functions: {
    ...
    "marketLeverageUpReceiver(bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "marketLeverageUpReceiver"
      | "marketLeverageUpReceiver(bytes)"
      | "msgInspector"
      | "msgInspector()"
      | "name"
      | "name()"
  ...
  encodeFunctionData(
    functionFragment: "marketLeverageUpReceiver",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
    functionFragment: "marketLeverageUpReceiver(bytes)",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export interface UsdoLeverageReceiverModule extends BaseContract {
  contractName: "UsdoLeverageReceiverModule";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UsdoLeverageReceiverModuleInterface;
