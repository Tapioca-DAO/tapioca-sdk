...
export interface UsdoOptionReceiverModuleInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "exerciseOptionsReceiver",
  ...
  getEvent(nameOrSignatureOrTopic: "ExerciseOptionsReceived"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "ExerciseOptionsReceived(address,address,uint256,uint256)"
  ): EventFragment;
...
export interface ExerciseOptionsReceivedEventObject {
  user: string;
  target: string;
  oTapTokenId: BigNumber;
  paymentTokenAmount: BigNumber;
}
export type ExerciseOptionsReceivedEvent = TypedEvent<
  [string, string, BigNumber, BigNumber],
  ExerciseOptionsReceivedEventObject
>;

export type ExerciseOptionsReceivedEventFilter =
  TypedEventFilter<ExerciseOptionsReceivedEvent>;
...
export interface UsdoOptionReceiverModule extends BaseContract {
  contractName: "UsdoOptionReceiverModule";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UsdoOptionReceiverModuleInterface;
  ...
  filters: {
    ...
    "ExerciseOptionsReceived(address,address,uint256,uint256)"(
      user?: PromiseOrValue<string> | null,
      target?: PromiseOrValue<string> | null,
      oTapTokenId?: PromiseOrValue<BigNumberish> | null,
      paymentTokenAmount?: null
    ): ExerciseOptionsReceivedEventFilter;
    ExerciseOptionsReceived(
      user?: PromiseOrValue<string> | null,
      target?: PromiseOrValue<string> | null,
      oTapTokenId?: PromiseOrValue<BigNumberish> | null,
      paymentTokenAmount?: null
